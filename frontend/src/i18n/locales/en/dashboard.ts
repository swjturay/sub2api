  ...
  keys: {
    ...
    useKeyModal: {
      ...
      composite: {
        ...
        codexDescription: 'Configure Codex with API key authentication through this Composite group.',
        codexConfigTomlHint: 'Save the config.toml below under the Codex config directory and restart Codex; Codex uses its built-in model catalog, so no extra file is required.',
        codexNote: 'The API key is written to config.toml; Codex uses its built-in model catalog and does not need model_catalog_json. Protect the config file and restart Codex after saving it.',
      },
      routedCodex: {
        description: 'Configure Codex through the current routed group.',
        configTomlHint: 'Save the config.toml below under the Codex config directory and restart Codex; Codex uses its built-in model catalog, so no extra file is required.',
        note: 'The API key is written to config.toml; Codex uses its built-in model catalog and does not need model_catalog_json. Protect the config file and restart Codex after saving it.',
      },
      codexModelCatalog: {
        title: 'Codex model catalog',
        description: 'Optionally fetch model metadata to choose a default model; Codex config no longer references an external catalog file.',
        fetch: 'Fetch catalog',
        retry: 'Retry',
