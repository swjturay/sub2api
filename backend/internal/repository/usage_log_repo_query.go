...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		clientRequestTypeRaw      sql.NullInt64
	...
	log := &service.UsageLog{
		...
		ClientRequestType:         service.ClientRequestTypeFromInt16(int16(clientRequestTypeRaw.Int64)),
