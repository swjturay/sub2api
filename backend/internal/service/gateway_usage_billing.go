...
type RecordUsageInput struct {
	...
	ClientRequestType  ClientRequestType  // 客户端入站请求方式；零值按 Result.Stream 推导 sync/SSE
...
func (s *GatewayService) RecordUsage(ctx context.Context, input *RecordUsageInput) error {
	return s.recordUsageCore(ctx, &recordUsageCoreInput{
		...
		ClientRequestType:  input.ClientRequestType,
...
func (s *GatewayService) buildRecordUsageLog(
	...
	usageLog := &UsageLog{
		...
		ClientRequestType:     input.ClientRequestType.Normalize(),
