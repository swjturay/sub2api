...
func buildOpenAIAPIKeyModelsRequest(ctx context.Context, account *Account, validateBaseURL func(string) (string, error)) (*http.Request, error) {
	...
	// This builder serves API-key providers and the internal CPR hop, not Codex OAuth.
	// Identify the gateway without assigning either destination a Codex identity.
