...
// Codex backend client for WHAM calls. Referral transport remains isolated in
// OpenAIReferralClient and uses the browser-oriented privacy client.
func ProvideOpenAIQuotaService(
	...
	service := NewOpenAIQuotaService(accountRepo, proxyRepo, tokenProvider, codexBackendClientFactory, referralClient)
